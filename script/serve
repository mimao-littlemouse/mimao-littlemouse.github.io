...
# 设定 端口 自动刷新浏览器 自动打开浏览器  指定读取开发环境下的配置文件 
# 还可指定的选项有：
# 设定 主机名
# --host 127.0.0.1
# 设定 端口
...
JEKYLL_ENV=${jekyll_env} JEKYLL_GITHUB_TOKEN=${github_token} bundle exec jekyll serve --livereload --open-url  --config _config.yml